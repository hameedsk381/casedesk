    ...
    <div className="pt-32 pb-24 max-w-7xl mx-auto px-5 sm:px-8">
      ...
      <div className="mt-16 grid md:grid-cols-2 gap-8 max-w-5xl">
        <div className="p-8 bg-white rounded-2xl border border-surface-3 shadow-xs">
          ...
          <h3 className="text-xl font-bold text-primary">Explicit Consent & Redaction</h3>
        ...
        <div className="p-8 bg-white rounded-2xl border border-surface-3 shadow-xs">
          ...
          <h3 className="text-xl font-bold text-primary">Isolated Local Filesystem</h3>
          <p className="mt-3 text-sm text-muted-foreground leading-relaxed">
        ...
        <div className="p-8 bg-white rounded-2xl border border-surface-3 shadow-xs">
          ...
          <h3 className="text-xl font-bold text-primary">Role-Based Access Control</h3>
          <p className="mt-3 text-sm text-muted-foreground leading-relaxed">
        ...
        <div className="p-8 bg-white rounded-2xl border border-surface-3 shadow-xs">
          ...
          <h3 className="text-xl font-bold text-primary">Audit Logging</h3>
          <p className="mt-3 text-sm text-muted-foreground leading-relaxed">
