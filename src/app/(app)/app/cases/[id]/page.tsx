    ...
    <div className="space-y-6">
      ...
      <div className="bg-white p-6 rounded-2xl border border-border-light shadow-xs space-y-3">
        <div className="flex items-center justify-between">
          ...
          <span className="px-2 py-0.5 rounded-full text-[10px] font-bold bg-electric-blue/10 text-electric-blue border border-electric-blue/20">
        ...
        {caseRecord.aiPriorityReason && (
          <div className="pt-2 text-xs text-slate-500 border-t border-border-light/60">
            <strong className="text-navy">Priority Assessment:</strong> {caseRecord.aiPriorityReason}
          </div>
        )}
      </div>
      ...
      <div className="bg-white p-6 rounded-2xl border border-border-light shadow-xs space-y-3">
        ...
        <div className="p-4 bg-off-white/70 rounded-xl border border-border-light font-mono text-xs text-navy leading-relaxed whitespace-pre-wrap">
        ...
        {caseRecord.sources?.[0] && (
          <div className="flex flex-wrap items-center justify-between text-xs text-slate-500 pt-2">
            <span>
              Intake Channel:{' '}
              <strong className="text-navy">{caseRecord.sourceType}</strong>
            </span>
            <span>
              Preferred Language:{' '}
              <strong className="text-navy">{caseRecord.sources[0].preferredLanguage}</strong>
            </span>
          </div>
        )}
      </div>
        ...
        <div className="bg-white p-6 rounded-2xl border border-border-light shadow-xs space-y-4">
          <div className="flex items-center justify-between pb-3 border-b border-border-light">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-sm font-bold text-navy">What We Know (Verified)</h3>
            </div>
            <span className="text-xs font-bold text-teal px-2 py-0.5 rounded bg-teal/10">
              ...
              {verifiedItems.map((item: any) => (
                <div key={item.id} className="text-xs space-y-1">
                  <div className="flex items-start gap-2">
                    ...
                    <span className="font-semibold text-navy leading-snug">{item.statement}</span>
                  </div>
                  {item.notes && (
        ...
        <div className="bg-white p-6 rounded-2xl border border-border-light shadow-xs space-y-4">
          <div className="flex items-center justify-between pb-3 border-b border-border-light">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-sm font-bold text-navy">What Remains Unverified</h3>
            </div>
              ...
              {unverifiedClaims.map((claim: any) => (
                <div key={claim.id} className="text-xs space-y-1">
                  <div className="flex items-start gap-2">
                    ...
                    <span className="font-semibold text-navy leading-snug">{claim.text}</span>
                  </div>
      ...
      <div className="bg-white p-6 rounded-2xl border border-border-light shadow-xs space-y-4">
        ...
        <div className="grid sm:grid-cols-3 gap-4">
          <Link
            ...
            className="p-4 rounded-xl bg-off-white/60 border border-border-light hover:border-electric-blue transition-colors group"
          >
            <div className="text-xs font-bold text-navy group-hover:text-electric-blue transition-colors mb-1">
          ...
          <Link
            ...
            className="p-4 rounded-xl bg-off-white/60 border border-border-light hover:border-coral transition-colors group"
          >
            <div className="text-xs font-bold text-navy group-hover:text-coral transition-colors mb-1">
          ...
          <Link
            ...
            className="p-4 rounded-xl bg-off-white/60 border border-border-light hover:border-teal transition-colors group"
          >
            <div className="text-xs font-bold text-navy group-hover:text-teal transition-colors mb-1">
