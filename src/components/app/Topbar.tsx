    ...
    <header className="sticky top-0 z-30 h-16 bg-white/90 backdrop-blur-md border-b border-border-light flex items-center justify-between px-4 sm:px-6">
      ...
      <div className="flex items-center gap-3">
        ...
        >
          ...
          <kbd className="ml-auto hidden sm:inline-flex items-center gap-0.5 px-1.5 py-0.5 rounded bg-white border border-border-light text-[10px] text-slate-500 font-mono">
            ⌘K
          </kbd>
        </button>
      </div>
